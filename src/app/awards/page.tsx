...
export default function AwardsPage() {
  ...
  return (
    <PageLayout title="中标公示" description="光伏储能项目中标结果公示，每条均标注原始出处">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        <div className="relative flex-1 min-w-[180px]">
          ...
          <Input placeholder="搜索中标标题、公司..." value={search} onChange={e => setSearch(e.target.value)} className="pl-8 h-9 text-sm" />
        </div>
      ...
      <div className="space-y-3">
        {filtered.map(a => (
          <Card key={a.id} className="hover:shadow-md transition-shadow border border-slate-200/80 shadow-sm">
